    ...
    "components":[
        {
            ...
            "type":"table",
            "cols":[
                {"field":"application.id","header":"ID"},
                {"field":"details.team_name","header":"Team"},
                {"field":"application.applying_teacher.username","header":"Docente"},
